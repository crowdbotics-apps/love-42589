"""
Django settings for love_42589 project.
...
WSGI_APPLICATION = 'love_42589.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "love_42589 API",
    "DESCRIPTION": "API documentation for love_42589 App",
    "VERSION": "v1",
}
